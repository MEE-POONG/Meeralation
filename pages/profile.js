      ...
      <div className=" bg-gray-700 text-white w-full h-40 py-2">
        <div className="px-5">
          <div className="container mx-auto max-w-lg py-2 h-full border-2 rounded-lg px-5 ">
            <div className=" flex justify-center mx-auto w-2/5 container mt-4 z-0" >
              <Image src="/aespa3.jpeg" width={80} height={80} className="rounded-full z-0 inline-block border-2 border-gray-500" />
            </div>
